...
class TestFilenameGeneration:
    def test_basic(self):
        assert (
            generate_filename("20260409221400", "My Note Title")
            == "20260409221400-my-note-title.md"
        )

    def test_lowercases(self):
        assert (
            generate_filename("20260409221400", "ALL CAPS")
            == "20260409221400-all-caps.md"
        )

    def test_non_ascii_transliterated(self):
        assert (
            generate_filename("20260409221400", "Über Cool")
            == "20260409221400-uber-cool.md"
        )
